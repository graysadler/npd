...
/**
 * @file
 * Theme setting callbacks for the md_bigstream theme.
 */
global $base_url;
define('THEME_PATH', drupal_get_path('theme', 'md_bigstream'));
define('CURRENT_THEME', variable_get('theme_default'));
define('BASE_THEME', 'md_bigstream');

require_once DRUPAL_ROOT . '/' . drupal_get_path('theme', 'md_bigstream') . '/inc/admin/utilities.inc';
require_once DRUPAL_ROOT . '/' . drupal_get_path('theme', 'md_bigstream') . '/inc/admin/form.inc';
require_once DRUPAL_ROOT . '/' . drupal_get_path('theme', 'md_bigstream') . '/inc/admin/theme-settings-general.inc';
require_once DRUPAL_ROOT . '/' . drupal_get_path('theme', 'md_bigstream') . '/inc/admin/theme-settings-design.inc';
require_once DRUPAL_ROOT . '/' . drupal_get_path('theme', 'md_bigstream') . '/inc/admin/theme-settings-text.inc';
require_once DRUPAL_ROOT . '/' . drupal_get_path('theme', 'md_bigstream') . '/inc/admin/theme-settings-pages.inc';
require_once DRUPAL_ROOT . '/' . drupal_get_path('theme', 'md_bigstream') . '/inc/admin/theme-settings-code.inc';
require_once DRUPAL_ROOT . '/' . drupal_get_path('theme', 'md_bigstream') . '/inc/admin/theme-settings-config.inc';
...
function md_bigstream_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL, $no_js_use = FALSE) {
  global $base_url;
  $path = drupal_get_path('theme', 'md_bigstream');
  ...
  $form['md_bigstream_settings']['html_header'] = array(
  ...
  md_bigstream_theme_settings_general($form, $form_state);
  md_bigstream_theme_settings_design($form, $form_state);
  md_bigstream_theme_settings_text($form, $form_state);
  md_bigstream_theme_settings_code($form, $form_state);
  md_bigstream_theme_settings_config($form, $form_state);


  $form['actions']['reset'] = array(
    '#type' => 'submit',
    '#value' => t('Reset Settings'),
    '#submit' => array('md_bigstream_reset_settings_submit'),
    '#weight' => 98,
    '#attributes' => array(
 ...
 */
function md_bigstream_reset_settings_submit($form, &$form_state) {
  $theme_settings = variable_get('theme_' . variable_get('theme_default') . '_settings');
  $default_settings = _md_bigstream_theme_default_settings($theme_settings);
 ...
 */
function md_bigstream_restore_theme_settings($form, &$form_state) {
 ...
 */
function _md_bigstream_theme_default_settings($theme_settings) {
